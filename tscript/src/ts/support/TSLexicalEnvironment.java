...
public final class TSLexicalEnvironment
{
   ...
   * @return a reference to the binding of the name
   */
   ...
   *
   *  @param name name to be placed in the lexical environment
   *  @param configurableBinding indicates whether the binding can be
   *    deleted
   */
   ...
   *  <a href="http://www.ecma-international.org/ecma-262/5.1/#sec-10.5">the
   *  discussion of declaration binding instantiation</a>.
   *
   *  @param rawName parameter name as a Java string.
   *  @param value value to bind the name to.
   */
